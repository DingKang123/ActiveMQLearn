...
public class JMSListener {
    ...
    private static final Map<String, Destination> MQDESTS = new ConcurrentHashMap();
         ...
         * * @param listener		监听     　　*/
        public static synchronized void startJmsQueueListener(String queueName,
    ...
    *  *@param  subName    订阅者的名字     　　*
    * @param listener   监听     　　*/
    public static synchronized void startJmsTopicListener(String topicName,
                                                          MessageListener listener)
    {
    ...
    private static void startJmsListener(Destination dest,
                                         String subName,
